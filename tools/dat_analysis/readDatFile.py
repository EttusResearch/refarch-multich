...
# This utility allows for the viewing of dat files generated by the MRFRA architecture.
# Example Use: python3 readDatFile.py -folder0="/mnt/md1/" -folder1="/mnt/md0/" -n -numfolders=1 -base-rx="rx_00" -signal-freq =500000 -start-point=0 -end-point=16000  -fs="250000000" 
# Using the -n flag will return the (numfolders) newest folders from the directories pointed to by -folder0 and -folder1. 
# The frequency of the sinusoid in the transmitted file is -signal-freq =500000
# This sets the windows for the average phase calculations automatically. It can be overridden by using -ppw=X instead, for a window of 500 use -ppw=500.
# Without the flag: python3 readDatFile.py -folder0="/mnt/md0/CW_2.000000_GHz_03302022_082627_test" -folder1="/mnt/md1/CW_2.000000_GHz_03302022_082627_test" -signal-freq =500000  -base-rx="rx_00" -start-point=0 -end-point=16000 -fs="250000000" 
