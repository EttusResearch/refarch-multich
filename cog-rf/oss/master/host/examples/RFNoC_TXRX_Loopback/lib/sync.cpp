...
void SyncDevices::setLOs(GraphSettings& graphSettings, const ProgramMetaData& pmd, DeviceSettings& deviceSettings){
    ...
    if (pmd.vm.count("enable_lo")) {
        ...
        for (auto& rctrl : graphSettings.radio_ctrls){
            ...
            std::cout << "Setting TX LO chan 0..." << std::endl;
            
            rctrl->set_tx_lo_export_enabled(true, "lo1", 0);
            graphSettings.radio_ctrls[4]->set_tx_lo_export_enabled(false,"lo1", 0);
            graphSettings.radio_ctrls[5]->set_tx_lo_export_enabled(false,"lo1", 0);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_3/export").set(true);

            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_3/export").set(true);
           
            std::this_thread::sleep_for(std::chrono::milliseconds(100));
            rctrl->set_tx_lo_source("external", "lo1",0);
            //rctrl->set_tx_lo_freq(deviceSettings.tx_freq, "lo1", 0);


            std::cout << "Setting RX LO chan 0..." << std::endl;
            
            rctrl->set_rx_lo_export_enabled(false, "lo1", 0);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_3/export").set(true); 
            
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(true);
            graphSettings.graph->get_tree()->access<bool>("blocks/2/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_3/export").set(true); 
            
            std::this_thread::sleep_for(std::chrono::milliseconds(100));
            rctrl->set_rx_lo_source("external", "lo1",0);
            //rctrl->set_rx_lo_freq(rx_freq, "lo1", 0);

            //Checked Locked Sensors

            rx_sensor_names = rctrl->get_rx_sensor_names(0);
            tx_sensor_names = rctrl->get_tx_sensor_names(0);

            for (auto& name : rx_sensor_names){
                //std::cout << "RX Sensor: "<< name << std::endl;
            ...
            for (auto& name : tx_sensor_names){
                //std::cout << "TX Sensor: "<<name << std::endl;
...
void SyncDevices::setSource(int device, GraphSettings& graphSettings){
    ...
    //No difference between RX and TX LOs, just choose TX. 
